...
#include "perception/camerad_component/visionipc/ipc.h"
#include "perception/camerad_component/visionipc/visionipc_client.h"
#include "perception/camerad_component/visionipc/visionipc_server.h"
...
bool VisionIpcClient::connect(bool blocking){
  ...
  int _num_buffers = num_buffers;
  r = ipc_sendrecv_with_fds(false, socket_fd, &bufs, sizeof(bufs), fds, VISIONIPC_MAX_FDS, &_num_buffers);
