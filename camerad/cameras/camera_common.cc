...
void CameraBuf::init(cl_device_id device_id, cl_context context, CameraState *s, 
            VisionIpcServer * v, int frame_cnt, VisionStreamType rgb_type, VisionStreamType yuv_type, 
  ...
  for (int i = 0; i < frame_buf_count; i++) {
    auto pb_image = std::make_shared<FrameData>();
