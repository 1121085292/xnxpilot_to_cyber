...
#include "xnxpilot/selfdrive/common/modeldata.h"
#include "xnxpilot/selfdrive/common/params.h"
#include "xnxpilot/selfdrive/common/swaglog.h"
#include "xnxpilot/selfdrive/common/util.h"
#include "xnxpilot/selfdrive/hardware/hw.h"
...
void publish_thumbnail(std::shared_ptr<apollo::cyber::Writer<Thumbnail>>& writer, const CameraBuf *b) {
  ...
  out_msg->set_frameid(b->cur_frame_data.frame_id);
  // thumbnaild.setFrameId(b->cur_frame_data.frame_id);
  out_msg->settimestampeof(b->cur_frame_data.timestamp_eof);
  // thumbnaild.setTimestampEof(b->cur_frame_data.timestamp_eof);
  out_msg->setthumbnail(thumbnail_buffer, thumbnail_len);
