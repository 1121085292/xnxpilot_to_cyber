...
#include "calibration_component/transformations/camera.h"
...
#define MAX_ALLOWED_SPEEDAD 2 * 180.0 / M_PI
...
class CalibrationComponent : public Component<CameraOdometry, CarState>{
  public:
    bool Init() override;
    bool Proc(const std::shared_ptr<CameraOdometry>& cam_odometry,
              const std::shared_ptr<CarState>& car_state) override;
